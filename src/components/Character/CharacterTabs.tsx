...
import { Award, Backpack, Hammer } from 'lucide-react';
...
import { Equipment, InventoryItem, SavedCharacter } from '../../types/game';
import { InventoryPanel } from '../Inventory/InventoryPanel';

type CharacterTabId = 'inventory' | 'professions' | 'achievements';
